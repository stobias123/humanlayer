...
0a. use `linear` skill and fetch the selected item into thoughts with the ticket number - ./thoughts/shared/tickets/ENG-xxxx.md
0b. read the ticket and all comments to learn about past implementations and research, and any questions or concerns about them

### PART I - IF NO TICKET IS MENTIONED

0.  use the linear skill.
    0a. find the project that matches the current git directory as best you can tell. use `linear list-projects`
    0b. select a ticket that needs a plan.
...
1. move the item to "plan in progress" using the MCP tools
   1a. read the details of the slash command `~/.claude/commands/create_plan.md`
